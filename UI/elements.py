...
self.KobaltButton.clicked.connect(lambda: self.generatePopUp("Kobalt"))
...
self.AntymsenButton.clicked.connect(lambda: self.generatePopUp("Antymsen"))
...
self.DarmsztadButton.clicked.connect(lambda: self.generatePopUp("Damstadtium"))
self.RoentgenButton.clicked.connect(lambda: self.generatePopUp("Roentgenium"))
self.KopernikButton.clicked.connect(lambda: self.generatePopUp("Kopernicium"))
self.NihonButton.clicked.connect(lambda: self.generatePopUp("Nihonium"))
self.FlerowButton.clicked.connect(lambda: self.generatePopUp("Flerovium"))
self.MoskowButton.clicked.connect(lambda: self.generatePopUp("Moscovium"))
self.LivermorButton.clicked.connect(lambda: self.generatePopUp("Livermorium"))
self.TenesButton.clicked.connect(lambda: self.generatePopUp("Tennessine"))
